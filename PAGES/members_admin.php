...
<head>
	...
	<style>
		ul.links a[href="members_admin.php"] li {
		...
		<div class="box">
			<div class="card">
				<div class="content-box">
				  ...
				  <a href="DIT_admin.php"><button class="btn">See members<div class="background"></div></button></a>
				</div>
				<div class="date-box">
		...
		<div class="box">
			<div class="card">
				<div class="content-box">
				  ...
				  <a href="DCEA_admin.php"><button class="btn">See members<div class="background"></div></button></a>
				</div>
				<div class="date-box">
		...
		<div class="box">
			<div class="card">
				<div class="content-box">
				  ...
				  <a href="DCEE_admin.php"><button class="btn">See members<div class="background"></div></button></a>
				</div>
				<div class="date-box">
		...
		<div class="box">
			<div class="card">
				<div class="content-box">
				  ...
				  <a href="DAFE_admin.php"><button class="btn">See members<div class="background"></div></button></a>
				</div>
				<div class="date-box">
		...
		<div class="box">
			<div class="card">
				<div class="content-box">
				  ...
				  <a href="DIET_admin.php"><button class="btn">See members<div class="background"></div></button></a>
				</div>
				<div class="date-box">
